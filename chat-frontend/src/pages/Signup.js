...
function Signup() {
    ...
    async function handleSignup(e) {
        ...
        console.log(url);
        // signup the user
        signupUser({ name, email, password, surname, picture: url }).then(({ data }) => {
            if (data) {
                console.log(data);
                navigate("/chat");
            }
                            ...
                            <Col>
                                <Row>
                                    <Form.Group className="mb-3" controlId="formBasicName">
                                        ...
                                        <Form.Control type="text" placeholder="Surname" onChange={(e) => setSurname(e.target.value)} value={surname} />
                                    </Form.Group>
                                </Row>
                            </Col>
                        </Row>
